...
// NewWithContext provides a mock function with given fields: ctx
func (_m *MockConn) NewWithContext(ctx context.Context) Conn {
	ret := _m.Called(ctx)

	if len(ret) == 0 {
		panic("no return value specified for NewWithContext")
	}
